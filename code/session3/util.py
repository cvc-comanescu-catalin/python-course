def get_value(prompt, value_min=0, value_max=100):
    '''
    Reads an integer value from user input, ensuring it's within the specified range.
    Args:
        prompt (str): The message displayed to the user when asking for input.
        value_min (int): The minimum acceptable value (inclusive).
        value_max (int): The maximum acceptable value (inclusive).
    Returns:
        int: The value entered by the user within the specified range.
    '''
    while True:
        try:
...
def read_float_ranged(prompt, value_min=0.0, value_max=100.0):
    '''
    Reads a float value from user input, ensuring it's within the specified range.
    Args:
        prompt (str): The message displayed to the user when asking for input.
        value_min (float): The minimum acceptable value (inclusive).
        value_max (float): The maximum acceptable value (inclusive).
    Returns:
        float: The value entered by the user within the specified range.
    '''
    while True:
        try:
